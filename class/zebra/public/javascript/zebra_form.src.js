 ...
 *  @version    2.7.6b (last revision: December 06, 2011)
        ...
        plugin.init = function() {
            ...
            $form.find('div.error').each(function() {
                ...
                var error_block = $(this),
                    ...
                    close_button = error_block.first('div.close a');
            ...
            elements.each(function() {
                ...
                if (
                    ...
                    var
                        ...
                        // get element's offset relative to the document
                        position = element.offset(),

                        // create a text element that will float above the element until the user starts typing in the element
                        placeholder = jQuery('<span>').attr({
                        ...
                        .html(attributes.type == 'text' || attributes.type == 'password' ? element.attr('alt') : element.attr('title'))
                    ...
                    // when the placeholder is clicked
                    ...
                    element.bind({
                        ...
                        'focus':    function() { placeholder.css('display', 'none') },

                        // if element loses focus but it's empty, show the placeholder
                        'blur':     function() { if (element.val() == '') placeholder.css('display', 'block') }

                    });

                    // when the browser window is resized
                    // make sure to also reposition the placeholders accordingly
...
//                     }
                    ...
                    // (we only show one error at a time)
                    break;
        ...
        plugin.validate_control = function(element) {
            ...
            // if control has any validation rules attached and is not hidden
            if (undefined != control_validation_rules && element.css('display') != 'none' && element.css('visibility') != 'hidden') {
        ...
        var _check_values = function() {
            ...
            // continue to check every 50 milliseconds
            setTimeout(_check_values, 50);

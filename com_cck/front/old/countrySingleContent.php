...
$countryName = $dataField->loadByName($dataId, "title");
//print_r($countryName);exit;
$data->loadList(null, null, null, array("#__cck_data.contentTypeId" => 4));
?>
<div class="breadcrumb"><a href="index.php">Начало</a> > <a href="<?=$countryListContentUrl?>">Държави</a></div><br>

<h1>Събития в <?=$countryName["value"]?></h1>
<div>
	...
	while ($data->next()) {
		...
		if ($fieldList["countryId"]["value"] != $dataId) continue;

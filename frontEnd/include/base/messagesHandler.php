...
if (isset($_SESSION["userSession"]["pageMessages"])) {

	$messageArray = $_SESSION["userSession"]["pageMessages"];

	unset($_SESSION["userSession"]["pageMessages"]);

}

if (isset($_SESSION["userSession"]["pageErrors"])) {

	$errorArray = $_SESSION["userSession"]["pageErrors"];

	unset($_SESSION["userSession"]["pageErrors"]);
